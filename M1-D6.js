...
*/
separateExercise("3 - Functions")

const splitMe = function(string){
  let result = string.split(" ")
  return result
}
console.log(splitMe("This string will be turned in an array!"))
...
const onlyInThisMillennium = function(){
  let startOf3rdMillenium = 2000
  let ThirdMilleniumTitles = []
  
  for (i =0; i < movies.length; i++){
    if (movies[i].Year > startOf3rdMillenium){
      ThirdMilleniumTitles.push(movies[i].Title )
    }
    
  }return ThirdMilleniumTitles.join("\n"  )
}
